                                ...
                                <div className="row justify-content-center g-0">
                                    ...
                                    <div className="col-lg-6">
                                        <div className="p-lg-5 p-4">
                                            ...
                                            <div className="mt-4">
                                                <form className="needs-validation" action="index.html">
                                                    <div className="mb-3">
                                                    ...
                                                    <div className="mb-4">
                                                        <p className="mb-0 fs-13 text-muted fst-italic">By registering you agree to the Velzon <Link to="#" className="text-primary text-decoration-underline fst-normal fw-semibold">Terms of Use</Link></p>
                                                    </div>
                                                    <div id="password-contain" className="p-3 bg-light mb-2 rounded">
                                                        <h5 className="fs-13">Password must contain:</h5>
                                                        <p id="pass-length" className="invalid fs-13 mb-2">Minimum <b>8 characters</b></p>
                                                        <p id="pass-lower" className="invalid fs-13 mb-2">At <b>lowercase</b> letter (a-z)</p>
                                                        <p id="pass-upper" className="invalid fs-13 mb-2">At least <b>uppercase</b> letter (A-Z)</p>
                                                        <p id="pass-number" className="invalid fs-13 mb-0">A least <b>number</b> (0-9)</p>
                                                    </div>
                                                    <div className="mt-4">
                                                        <button to="/dashboard" className="btn btn-success w-100" type="submit">Sign Up</button>
                                                    </div>
                                            ...
                                            <div className="mt-5 text-center">
                                                <p className="mb-0">Already have an account ? <Link to="auth-signin-cover.html" className="fw-bold text-primary text-decoration-underline"> Signin</Link> </p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
